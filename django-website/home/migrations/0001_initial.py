# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-01-21 16:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(help_text='The team member bio', max_length=1000)),
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='team', to='home.HomePage')),
